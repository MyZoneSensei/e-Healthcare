        ...
        <section class="department-icons">
            <div class="container">
                <div class="icons-grid">
                    ...
                    <a href="Ophtalmology.php" class="icon-card active">
        ...
        <section class="content">
            <div class="container">
                <div class="content-intro">
                    <h2>Ophthalmology</h2>
                    <p>Welcome to the Ophthalmology Department. Our team of skilled ophthalmologists, and eye care professionals is committed to providing comprehensive eye care services.</p>
                </div>
                ...
                <div class="content-grid">
                    <div class="text-block">
                        ...
                        <ul>
                            ...
                            <li>Eye pressure measure</li>
                            <li>Refraction</li>
                        </ul>
                    </div>
                    <div class="image-block">
                        <img src="img/Oph1.jpg" alt="Personalized diagnosis">
                ...
                <div class="content-grid reverse">
                    <div class="text-block">
                        ...
                        <ul>
                            ...
                            <li>ELaser vision correction</li>
                            <li>Glaucoma management</li>
                            <li>Retinal surgery</li>
                        </ul>
                    </div>
                    <div class="image-block">
                       <img src="img/Oph2.jpg" alt="Treatment Solutions">
