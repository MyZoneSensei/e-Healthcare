        ...
        <section class="department-icons">
            <div class="container">
                <div class="icons-grid">
                    ...
                    <a href="Neurology.php" class="icon-card">
                        <div class="icon-wrapper">🧠</div>
                        <span>Neurology</span>
                    </a>
                    ...
                    <a href="Gynecology.php" class="icon-card active">
                        <div class="icon-wrapper">🚺</div>
        ...
        <section class="content">
            <div class="container">
                <div class="content-intro">
                    <h2>Gynecology</h2>
                    <p>Welcome to the Gynecology Department. Our dedicated team of gynecologists and obstetricians is committed to providing comprehensive and compassionate care.</p>
                </div>
                ...
                <div class="content-grid">
                    ...
                    <div class="image-block">
                        <img src="img/Gyne1.jpeg" alt="Personalized diagnosis">
                ...
                <div class="content-grid reverse">
                    <div class="text-block">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur. Dignissim augue in purus scelerisque vitae. Phasellus arcu arcu ultrices ipsum cras neque. Adipiscing dui egestas at ac dapibus.</p>
                        <ul>
                            <li>Prenatal care</li>
                            <li>Postpartum care</li>
                            <li>pregnancy manage</li>
                            <li>Labor services</li>
                        </ul>
                    </div>
                    <div class="image-block">
                       <img src="img/Gyne2.jpeg" alt="Treatment Solutions">
