        ...
        <section class="department-icons">
            <div class="container">
                <div class="icons-grid">
                    ...
                    <a href="Pneumology.php" class="icon-card active">
                        <div class="icon-wrapper">🫁</div>
        ...
        <section class="content">
            <div class="container">
                <div class="content-intro">
                    <h2>Pneumology</h2>
                    <p>We offer comprehensive care for patients with respiratory conditions including diagnostics, treatment options, and support services.</p>
                </div>
                ...
                <div class="content-grid">
                    ...
                    <div class="image-block">
                        <img src="img/Pneu1.jpg" alt="Personalized diagnosis">
                ...
                <div class="content-grid reverse">
                    <div class="text-block">
                        ...
                        <p>Specialized care by our expert team. Diagnosis, monitoring, and personalized treatment plans based on your respiratory needs.</p>
                        <ul>
                    ...
                    <div class="image-block">
                       <img src="img/Pneu2.jpg" alt="Treatment Solutions">
