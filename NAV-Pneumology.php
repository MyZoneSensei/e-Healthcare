...
<head>
    ...
    <title>Pneumology Services | eHealthCare</title>
    ...
    <section class="hero">
        <div class="container">
           <a href="#" class="icon-card active">
                        <img src="img/icon-pneumology.png" alt="" class="icon-departement">
                        <span>Pneumology</span>
                    </a>
            <h1>Your Health, Our Priority</h1>
            <h2>Leaders in respiratory care, ensuring your lung health with expertise and compassion care</h2>
        </div>
    </section>
        ...
        <div class="container">
            <div class="services-inner">
                <div class="services-text">
                    <h3>Pneumology services: diagnostic and treatments</h3>
                    <ul class="services-list">
                        <li>
                            <strong>Diagnostics Services</strong>
                            <p>Our advanced diagnostic services are designed to accurately assess respiratory health. We offer a range of diagnostic tests and procedures, including</p>
                        </li>
                        <li>
                            <strong>Treatment Options</strong>
                            <p>Our pneumology department provides a comprehensive array of treatment options for various respiratory conditions</p>
                        </li>
                    </ul>
                </div>
                <div class="services-image">
                    <img src="img/Pneu2.jpg" alt="Doctor">
                </div>
            </div>
