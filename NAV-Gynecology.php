...
<head>
    ...
    <title>Gynecology Services | eHealthCare</title>
    ...
    <section class="hero">
        <div class="container">
           <a href="#" class="icon-card active">
                        <img src="img/icon-gynecology.png" alt="" class="icon-departement">
                        <span>Gynecology</span>
                    </a>
            <h1>Your Health, Our Priority</h1>
            <h2>Exceptional care for women at every stage of life dedicated to your well being</h2>
        </div>
    </section>
        ...
        <div class="container">
            <div class="services-inner">
                <div class="services-text">
                    <h3>Gynecology services: diagnostic and treatments</h3>
                    <ul class="services-list">
                        <li>
                            <strong>Routine gynecological care</strong>
                            <p>Our gynecology services cover a range of preventive and routine care</p>
                        </li>
                        <li>
                            <strong>Obstetric care</strong>
                            <p>For expectant mothers, we offer specialized obstetric services</p>
                        </li>
                    </ul>
                </div>
                <div class="services-image">
                    <img src="img/Gyne2.jpeg" alt="Doctor">
                </div>
            </div>
