...
<head>
    ...
    <title>Neurology Services | eHealthCare</title>
    ...
    <section class="hero">
        <div class="container">
           <a href="#" class="icon-card active">
                        <img src="img/icon-Neurology.png" alt="" class="icon-departement">
                        <span>Neurology</span>
                    </a>
            <h1>Your Health, Our Priority</h1>
            <h2>Leading-edge neurology: Dedicated to understanding, treating, and enhancing brain health with expertise</h2>
        </div>
    </section>
        ...
        <div class="container">
            <div class="services-inner">
                <div class="services-text">
                    <h3>Neurology services: diagnostic and treatments</h3>
                    <ul class="services-list">
                        <li>
                            <strong>Diagnostic services</strong>
                            <p>Our advanced diagnostic services are designed to accurately assess neurological health. We offer a range of diagnostic tests and procedures, including</p>
                        </li>
                        <li>
                            <strong>Treatment Options</strong>
                            <p>Our neurology department provides a comprehensive array of treatment options for various neurological conditions</p>
                        </li>
                    </ul>
                </div>
                <div class="services-image">
                    <img src="img/Neu1.jpeg" alt="Doctor">
                </div>
            </div>
