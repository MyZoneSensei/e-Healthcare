...
<head>
    ...
    <title>Ophthalmology Services | eHealthCare</title>
    ...
    <section class="hero">
        <div class="container">
           <a href="#" class="icon-card active">
                        <img src="img/icon-Ophthalmology.png" alt="" class="icon-departement">
                        <span>Ophthalmology</span>
                    </a>
            <h1>Your Health, Our Priority</h1>
            <h2>Your trusted partner for comprehensive eye care and vision solutions to enhance your eyes conditions</h2>
        </div>
    </section>
        ...
        <div class="container">
            <div class="services-inner">
                <div class="services-text">
                    <h3>Ophthalmology services: diagnostic and treatments</h3>
                    <ul class="services-list">
                        <li>
                            <strong>Comprehensive Eye Exams</strong>
                            <p>Our comprehensive eye exams cover a range of eye health assessments</p>
                        </li>
                        <li>
                            <strong>Surgical and Medical Interventions</strong>
                            <p>Our ophthalmology department offers a variety of surgical and medical interventions</p>
                        </li>
                    </ul>
                </div>
                <div class="services-image">
                    <img src="img/Oph2.jpg" alt="Doctor">
                </div>
            </div>
