        ...
        <section class="content">
            <div class="container">
                <div class="content-intro">
                    <h2>Cardiology</h2>
                    <p>We offer comprehensive Cardiology consultations, medical diagnosis, and preventive healthcare solutions. Learn more below.</p>
                </div>
                ...
                <div class="content-grid">
                    <div class="text-block">
                        ...
                        <ul>
                            ...
                            <li>Heart Failure</li>
                            <li>Arrhytmia management</li>
                            <li>Cardiac Surgery</li>
                        </ul>
                    </div>
                    <div class="image-block">
                        <img src="img/Dokter-Cardiology.jpg" alt="Personalized diagnosis">
                ...
                <div class="content-grid reverse">
                    <div class="text-block">
                        ...
                        <ul>
                            ...
                            <li> Cardiac Stress Testing (EKG)</li>
                            <li>Echocardiography</li>
                            <li>Cardiac Catheterization</li>
                        </ul>
                    </div>
                    <div class="image-block">
                       <img src="img/Cardiology.jpg" alt="Treatment Solutions">
