        ...
        <section class="department-icons">
            <div class="container">
                <div class="icons-grid">
                    ...
                    <a href="Odontology.php" class="icon-card active">
                        <div class="icon-wrapper">🦷</div>
        ...
        <section class="content">
            <div class="container">
                <div class="content-intro">
                    <h2>Odontology</h2>
                    <p>Our team of skilled dentists, oral surgeons, and dental hygienists is committed to providing top-quality dental and oral care.</p>
                </div>
                ...
                <div class="content-grid">
                    <div class="text-block">
                        ...
                        <ul>
                            ...
                            <li>Cleanings and hygiene</li>
                            <li>Oral Health</li>
                        </ul>
                    </div>
                    <div class="image-block">
                        <img src="img/Odon1.jpeg" alt="Personalized diagnosis">
                ...
                <div class="content-grid reverse">
                    <div class="text-block">
                        ...
                        <p>Specialized care by our expert team. Diagnosis, monitoring, and personalized treatment plans based on your dental needs.</p>
                        <ul>
                            <li>Orthodontics</li>
                            <li>Periodontics</li>
                    ...
                    <div class="image-block">
                       <img src="img/Odon2.jpeg" alt="Treatment Solutions">
